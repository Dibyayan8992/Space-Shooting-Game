...
function draw() {
  ...
  if(GAMESTATE === play_INSTRUCTION) {
    ...
    fill("red")
    text("THANK U FOR USING SPACE HARRIER, TO PLAY THIS GAME U NEED A DESKTOP, IF YOU WANT TO PLAY THIS GAME.",width/18,height-height/1.5);
    ...
    text("WHILE YOU ARE PLAYING YOU WILL SEE A PLAYER...PLAYER NAME IS-'DIBYAYAN KAR'...PLAYER DIBYAYAN KAR IS THE DEVELOPER OF THIS GAME YOU WILL PLAY THIS GAME NOT ALONE YOU HAVE TO PLAY THIS GAME WITH THIS GAME DEVELOPER...THIS IS COMPULSARY TO PLAY THIS GAME WITH THE DEVELOPER",width/18,height-height/2.310);
...
drawSprites();
      ...
      if(GAMESTATE === HOME) {
        ...
        textSize(28);
        textFont('Georgia');
        text("PLAY",PLAY_BUTTON.x-32,PLAY_BUTTON.y+7);
        textSize(20)
      ...
      if(GAMESTATE === PLAY) {
        ...
        if(player_Friend_Life >= 1) {
             ...
             textSize(30);
             textFont('Italic')
             text("DIBYAYAN KAR'S LIFE: "+player_Friend_Life,400,40);
             text("DIBYAYAN KAR",computerplayer.x-60,computerplayer.y-50)
        } else{
          fill("white")
          textSize(30);
          textFont('Italic');
          text("DIBYAYAN KAR DIED",400,40)
        }
        fill("white")
        textSize(30);
        textStyle(ITALIC);
        text("SCORE:"+score,800,40);
        text("QUIT",home_play_button.x-37,home_play_button.y+8);
